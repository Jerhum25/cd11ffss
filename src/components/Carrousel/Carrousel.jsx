...
const Carrousel = () => {
  ...
  const images = [
    {
      url: "./img/carrousel1.jpg",
      title: "Protéger",
      description:
        "Nous protégeons et sécurisons vos manifestations événementielles",
    },
    {
      url: "./img/carrousel2.png",
      title: "Secourir",
      description: "Nous sommes au service de la population en cas de sinistre",
    },
    {
      url: "./img/carrousel3.png",
      title: "Former",
      description: "Nous vous formons à sauver des vies",
    },
  ];
